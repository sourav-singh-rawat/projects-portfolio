    ...
    apps: [
      {
        ...
        phone_screenshots: [
          ...
          "./assets/nova/phone/08.webp",
          "./assets/nova/phone/09.webp",
          "./assets/nova/phone/10.webp",
          "./assets/nova/phone/11.webp",
          "./assets/nova/phone/12.webp",
          "./assets/nova/phone/13.webp",
        ],
        videos: ["./assets/nova/video/01.mp4"],
      },
    ],
  },
  {
    ...
    apps: [
      {
        ...
        tags: ["iPhone", "Android"],
        phone_screenshots: [
          "./assets/qoohoo/phone/01.webp",
          "./assets/qoohoo/phone/02.jpeg",
          "./assets/qoohoo/phone/03.jpeg",
          "./assets/qoohoo/phone/04.webp",
          "./assets/qoohoo/phone/05.webp",
          "./assets/qoohoo/phone/06.webp",
          "./assets/qoohoo/phone/07.webp",
          "./assets/qoohoo/phone/08.webp",
          "./assets/qoohoo/phone/09.webp",
          "./assets/qoohoo/phone/10.webp",
          "./assets/qoohoo/phone/11.webp",
          "./assets/qoohoo/phone/12.webp",
          "./assets/qoohoo/phone/13.webp",
          "./assets/qoohoo/phone/14.webp",
          "./assets/qoohoo/phone/15.jpeg",
          "./assets/qoohoo/phone/16.webp",
        ],
        videos: ["./assets/qoohoo/video/01.mp4"],
      },
    ],
  },
];
