    ...
    apps: [
      {
        ...
        phone_screenshots: [
          "./assets/alitas/transcribe_go/phone/01.png",
          "./assets/alitas/transcribe_go/phone/02.png",
          "./assets/alitas/transcribe_go/phone/03.png",
          "./assets/alitas/transcribe_go/phone/04.png",
          "./assets/alitas/transcribe_go/phone/05.png",
          "./assets/alitas/transcribe_go/phone/06.png",
          "./assets/alitas/transcribe_go/phone/07.png",
          "./assets/alitas/transcribe_go/phone/08.png",
        ],
        tablet_screenshots: [
          "./assets/alitas/transcribe/tablet/01.png",
          "./assets/alitas/transcribe/tablet/02.png",
          "./assets/alitas/transcribe/tablet/03.png",
          "./assets/alitas/transcribe/tablet/04.png",
          "./assets/alitas/transcribe/tablet/05.png",
          "./assets/alitas/transcribe/tablet/06.png",
        ],
      },
      {
